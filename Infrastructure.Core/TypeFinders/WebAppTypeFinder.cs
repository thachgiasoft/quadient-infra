...
namespace Infrastructure.Core.TypeFinders
{
    ...
    public class WebAppTypeFinder : AppDomainTypeFinder
    {
        ...
        public WebAppTypeFinder(CoreConfiguration config)
        {
            _ensureBinFolderAssembliesLoaded = config.DynamicDiscovery;
            if (!string.IsNullOrEmpty(config.AssemblySkipLoadingPattern))
                AssemblySkipLoadingPattern = config.AssemblySkipLoadingPattern;
        }
