...
using System.Linq;
using System.Web;
using Infrastructure.Exceptions.DependencyExceptions;
...
namespace Infrastructure.Core.DependencyManagemenet
{
    ...
    public class ContainerManager
    {
        ...
        public ContainerManager(IContainer container, CoreConfiguration configuration)
        {
        ...
        public virtual object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            throw new DependencyException("No constructor  was found that had all the dependencies satisfied.");
        }
        ...
        public virtual bool TryResolve(Type serviceType, out object instance, ILifetimeScope scope = null)
        {
            if (scope == null)
            {
                //no scope specified
        ...
        public virtual ILifetimeScope Scope()
        {
            try
            {
                var scope = LifeTimeScopeProviderHelper.GetLifeTimeScope(_configuration);
                //when such lifetime scope is returned, you should be sure that it'll be disposed once used (e.g. in schedule tasks)
                if (scope == null)
                    scope = StaticAppLifetimeScopeProvider.GetLifetimeScope(_configuration, Container);
                return scope;
            }
            catch (Exception)
            {
