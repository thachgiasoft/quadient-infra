...
namespace Infrastructure.Caching
{
    ...
    public static class CacheExtensions
    {
        ...
        public static T Get<T>(this ICacheManager cacheManager, string key, Func<T> acquire) where T : class
        {
        ...
        /// <param name="acquire">Function to load item if it's not in the cache yet</param>
        /// <returns>Cached item</returns>
        public static T Get<T>(this ICacheManager cacheManager, string key, int cacheTime, Func<T> acquire) where T : class
        {
